...
class _SignupPageState extends State<SignupPage> {
  ...
  final TextEditingController dobController = TextEditingController();
  final TextEditingController genderController = TextEditingController();
  final TextEditingController clubmembershipController =
        ...
        child: Column(
          ...
          children: [
              ...
              children: [
                DropdownButtonFormField<String>(
                  ...
                  onChanged: (value) {
                    ...
                    // Find the selected schedule and print its ID
                    final selectedScheduleItem =
                        scheduleController.scheduleData.firstWhere(
                      (schedule) => schedule.group == value,
                      orElse: () => ScheduleModel(
                        id: '',
                        group: '',
            ...
            TextFormField(
              controller: dobController,
              readOnly:
                  true, // Make the TextField read-only so the user can't manually input the date
              decoration: InputDecoration(
                prefixIcon: IconButton(
            ...
            Row(
              ...
              children: <Widget>[
                ...
                SizedBox(
                    width: 16.0), // Space between the heading and checkboxes
                Obx(() => Row(
                      children: <Widget>[
                        Checkbox(
                          value:
                ...
                SizedBox(
                    width: 16.0), // Space between Male and Female checkboxes
                Obx(() => Row(
                      children: <Widget>[
                        Checkbox(
                          value:
                ...
                Obx(() => Row(
                      children: <Widget>[
                        Checkbox(
                          value: signupController.DACCMembership.value == 'Yes',
                          onChanged: (bool? value) {
                            signupController.DACCMembership.value =
                                value == true ? 'Yes' : 'N/A';
                          },
                        ),
                        const Text('Yes'),
              ...
              children: <Widget>[
                ...
                Obx(() => Row(
                      children: <Widget>[
                        Checkbox(
                          value:
                              signupController.selectedClubCard.value == 'Yes',
                          onChanged: (bool? value) {
                            signupController.selectedClubCard.value =
                                value == true ? 'Yes' : 'N/A';
                          },
                        ),
                        const Text('Yes'),
                ...
                Obx(() => Row(
                      children: <Widget>[
                        Checkbox(
                          value:
                              signupController.selectedClubCard.value == 'No',
                          onChanged: (bool? value) {
                            signupController.selectedClubCard.value =
                                value == true ? 'No' : 'N/A';
                          },
                    ...
                    : ElevatedButton(
                        ...
                        onPressed: () {
                          ...
                          if (addressController == null ||
                            ...
                            showValidationDialog(
                                'Input Required', 'Please enter your Address');
                            return;
                          }
                          ...
                          if (clubmembershipController == null ||
                              clubmembershipController.text.trim().isEmpty) {
                            showValidationDialog('Input Required',
                                'Please enter your MememberShip Number');
                            return;
                          }
                          ...
                          final userModel = UserModel(
                            ...
                            parentname: parentnameController.text.isEmpty
                                ? 'N/A'
                            ...
                            gender: signupController.selectedGender.value,
                            clubmembership:
                                clubmembershipController.text.isEmpty
                                    ? 'N/A'
                                    : clubmembershipController.text,
                            clubcardcopy:
                                signupController.selectedClubCard.value,
                            scheduleIds: selectedScheduleItem.id,
                            regestrationtype: 'academy',
